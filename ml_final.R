...
model_lda<-lda(Stecaj~ Attr21 + Attr24 + Attr25 + Attr37 + Attr38 +Attr41 +Attr46 +Attr55 , data=train)
model_lda
...
model_qda<-qda(Stecaj~ Attr21 + Attr24 + Attr25 + Attr37 + Attr38 +Attr41 +Attr46 +Attr55, data=train)
model_qda
