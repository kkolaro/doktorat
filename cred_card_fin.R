...
# Podaci bez faktor promenjivih, za H2o (osim za zavisno promenjivu)
...
write.csv(default_cr, "C:\\Users\\kkolaro\\OneDrive - ENDAVA\\Desktop\\Doktorat\\Rad\\last\\default_cr.csv", row.names=FALSE)
write.csv(default_cr_norm, "C:\\Users\\kkolaro\\OneDrive - ENDAVA\\Desktop\\Doktorat\\Rad\\last\\default_cr_norm.csv", row.names=FALSE)
write.csv(default_cr_h2o, "C:\\Users\\kkolaro\\OneDrive - ENDAVA\\Desktop\\Doktorat\\Rad\\last\\default_cr_h2o.csv", row.names=FALSE)
...
write.csv(default_pc,"C:\\Users\\kkolaro\\OneDrive - ENDAVA\\Desktop\\Doktorat\\Rad\\last\\default_pc.csv", row.names=FALSE)
...
# 9 Heterogeni modeli, konsolidacija
...
train_df_h2o<-as.h2o(default_cr_h2o[split,])
...
cm_h2o_gbm<-confusionMatrix(factor(predicted_h2o_gbm),
                            factor(test$default.payment.next),positive = "1")
